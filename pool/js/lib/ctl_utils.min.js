...
function isIOS() {
  for (
    ...
    if (navigator.platform === e.pop()) return (s_bIsIphone = !0), !0;
...
function getSize(e) {
  var n,
    ...
    o = window.document,
    i = o.documentElement;
  if (void 0 === window["inner" + e]) n = i["client" + e];
  else if (window["inner" + e] != i["client" + e]) {
    ...
    (s.id = "vpw-test-d"),
      ...
      (s.innerHTML =
        ...
        ":7px!important}}</style>"),
      a.appendChild(s),
      i.insertBefore(a, o.head),
      (n = 7 == s["offset" + e] ? i["client" + e] : window["inner" + e]),
      i.removeChild(a);
  } else n = window["inner" + e];
  return n;
}
...
function sizeHandler() {
  if ((window.scrollTo(0, 1), $("#canvas_game"))) {
    var e;
    e =
      null !== platform.name && "safari" === platform.name.toLowerCase()
        ...
        : getSize("Height");
    var n = getSize("Width");
    s_bFocus && _checkOrientation(n, e);
    var t = Math.min(e / CANVAS_HEIGHT, n / CANVAS_WIDTH),
      o = Math.round(CANVAS_WIDTH * t),
      i = Math.round(CANVAS_HEIGHT * t),
      a = 0;
    i < e
      ? ((i += a = e - i), (o += a * (CANVAS_WIDTH / CANVAS_HEIGHT)))
      : o < n && ((o += a = n - o), (i += a * (CANVAS_HEIGHT / CANVAS_WIDTH)));
    var s = e / 2 - i / 2,
      r = n / 2 - o / 2,
      c = CANVAS_WIDTH / o;
    (r * c < -EDGEBOARD_X || s * c < -EDGEBOARD_Y) &&
      ((t = Math.min(
        e / (CANVAS_HEIGHT - 2 * EDGEBOARD_Y),
        n / (CANVAS_WIDTH - 2 * EDGEBOARD_X)
      )),
      (o = Math.round(CANVAS_WIDTH * t)),
      (s = (e - (i = Math.round(CANVAS_HEIGHT * t))) / 2),
      (r = (n - o) / 2),
      (c = CANVAS_WIDTH / o)),
      (s_iOffsetX = -1 * r * c),
      (s_iOffsetY = -1 * s * c),
      ...
      null !== s_oDifficultyMenu && s_oDifficultyMenu.refreshButtonPos(),
      $("#canvas_game").css("width", o + "px"),
      $("#canvas_game").css("height", i + "px"),
      $("#canvas_3d").css("width", o + "px"),
      $("#canvas_3d").css("height", i + "px"),
      $("#canvas_upper_3d").css("width", o + "px"),
      $("#canvas_upper_3d").css("height", i + "px"),
      s < 0
        ? ($("#canvas_game").css("top", s + "px"),
          $("#canvas_3d").css("top", s + "px"),
          $("#canvas_upper_3d").css("top", s + "px"))
        : ((s = (e - i) / 2),
          $("#canvas_game").css("top", s + "px"),
          $("#canvas_3d").css("top", s + "px"),
          $("#canvas_upper_3d").css("top", s + "px")),
      $("#canvas_game").css("left", r + "px"),
      $("#canvas_3d").css("left", r + "px"),
      $("#canvas_upper_3d").css("left", r + "px"),
      fullscreenHandler();
  }
}
...
function createBitmap(e, n, t) {
  ...
  return (
    n && t
      ...
      : i.graphics.beginFill("#ff0").drawRect(0, 0, e.width, e.height),
    (o.hitArea = i),
    o
  );
}
function createSprite(e, n, t, o, i, a) {
  if (null !== n) s = new createjs.Sprite(e, n);
  else var s = new createjs.Sprite(e);
  var r = new createjs.Shape();
  return (
    r.graphics.beginFill("#000000").drawRect(-t, -o, i, a), (s.hitArea = r), s
  );
}
...
function formatTime(e) {
  ...
  var o = "";
  return (o += n < 10 ? "0" + n + ":" : n + ":"), (o += t < 10 ? "0" + t : t);
}
...
function tweenVolume(e, n, t, o = createjs.Ease.linear, i, a) {
  if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile) {
    var s = { from: s_aSounds[e].volume(), to: n };
    createjs.Tween.get(s, { override: !0 })
      .to({ from: s.to }, t, o)
      .on("change", function () {
...
function createGraphicCircle(e, n, t, o) {
  ...
  return (
    i.graphics.beginFill(o).drawCircle(e.x, e.y, n),
    null !== t && createjs.Tween.get(i).to({ alpha: 0, visible: !1 }, t),
    i
  );
}
function createGraphicLine(e, n, t, o, i) {
  ...
  return (
    a.graphics.setStrokeStyle(t, "round", "round"),
    a.graphics.beginStroke(i).moveTo(e.x, e.y).lineTo(n.x, n.y),
    null !== o && createjs.Tween.get(a).to({ alpha: 0, visible: !1 }, o),
    a
  );
}
...
function fullscreenHandler() {
  ENABLE_FULLSCREEN &&
    ...
    null !== s_oDifficultyMenu && s_oDifficultyMenu.resetFullscreenBut());
}
var s_iOffsetX,
  s_iOffsetY,
  s_iScaleFactor = 1,
...
!(function (e) {
  ...
  (this.tweenValue = function (e, n, t) {
    return e + t * (n - e);
  }),
  ...
  (function () {
    function e(e) {
      ...
      (e = e || window.event).type in i
        ? (document.body.className = i[e.type])
        : ((document.body.className = this[n] ? "hidden" : "visible"),
